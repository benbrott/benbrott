...
class RotatingSquares extends React.PureComponent {
  static propTypes = { primaryColor: PropTypes.string }

  render() {
    const primaryColor = this.props.primaryColor;
    return (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" stroke={primaryColor} strokeWidth="3" strokeLinejoin="round" fill="none">
        <path d="
          M 10,50       
          L 50,10       
          L 90,50
        ...
        ">
          ...
          <animate attributeName="strokeWidth" values="1;3;1;1;"  dur="2s" repeatCount="indefinite"/>
        </path>
        <path d="
          M 30,30       
          L 70,30       
